...
const CustomAlert = ({ message, type, onClose }) => {
  ...
  return (
    <div className={`fixed top-5 right-5 z-50 flex items-center w-full max-w-xs p-4 space-x-3 text-gray-500 bg-white rounded-lg shadow-2xl border-l-4 ${accentColor} transition-all duration-300 transform animate-slideIn`}>
