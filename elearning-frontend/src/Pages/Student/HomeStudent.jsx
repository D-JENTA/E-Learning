    ...
    <MainLayoutStudent>
      ...
      <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link to="/student/class" className="group relative bg-white rounded-3xl shadow-sm border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
